 ...
 *   - Fallback to now
 */
export function parsePancakeTime(raw) {
    if (!raw)
        return new Date();
...
// ─── Attachment Helpers ──────────────────────────────────────────────────────
export function mapAttachmentType(attachments) {
...
// ─── Note Serializer ─────────────────────────────────────────────────────────
export function serializePancakeNotes(raw) {
    if (!raw)
        return null;
    if (typeof raw === 'string') {
...
//# sourceMappingURL=pancake-helpers.js.map