 ...
 */
export function extractAvatarHash(avatarUrl) {
    if (!avatarUrl)
        return null;
 ...
 */
export function detectAvatarPlatform(avatarUrl) {
    if (!avatarUrl)
        return 'unknown';
 ...
 */
export function groupByAvatarHash(contacts) {
...
//# sourceMappingURL=avatar-hash.js.map