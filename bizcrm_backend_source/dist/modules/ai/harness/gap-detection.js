 ...
 */
const GAP_TYPES = ['missing_info', 'needs_knowledge', 'needs_staff'];
/** Coerce an arbitrary tool-supplied type to a valid GapType (default missing_info). */
export function normalizeGapType(t) {
    return GAP_TYPES.includes(t ?? '') ? t : 'missing_info';
}
...
export function isConfidentHit(score) {
...
export function looksLikeDefer(text) {
