...
export async function getOrCreateWebChannel(orgId, ownerUserId) {
 ...
 */
export async function deliverWebVisitorMessage(input) {
    ...
    if (!result)
        throw new Error('Không xử lý được tin nhắn web');
    return { conversationId: result.conversationId, threadId };
}
//# sourceMappingURL=web-chat-service.js.map