...
import { truncateData, recordDebug, getDebugLog, resetDebugLog, DEBUG_LOG_MAX, MAX_DATA_CHARS, MAX_SUMMARY_CHARS, MAX_LABEL_CHARS, MAX_ORG_BUFFERS, UNATTRIBUTED_MAX, } from './debug-log.js';
...
describe('truncateData', () => {
    ...
    it('survives a circular payload instead of throwing', () => {
        ...
        expect(result.truncated).toBe(true);
        expect(result.data.preview).toContain('không serialize');
    });
});
...
describe('stored entries are immutable', () => {
    it('rejects mutation of an entry handed out by getDebugLog', () => {
        ...
        expect(() => { entry.summary = 'bị sửa'; }).toThrow();
...
//# sourceMappingURL=debug-log.test.js.map