...
import { PERFEX_CONFIG_DEFAULTS } from './perfex-types.js';
...
export function normalizeConfig(raw) {
    ...
    return {
        ...
        syntheticEmailFallbackDomain: c.syntheticEmailFallbackDomain ?? PERFEX_CONFIG_DEFAULTS.syntheticEmailFallbackDomain,
...
export async function loadPerfexIntegration(orgId) {
...
export function decryptAuthToken(config) {
    if (!config.authTokenEnc)
        throw new Error('Perfex authToken not configured');
    return decryptToken(config.authTokenEnc);
}
//# sourceMappingURL=perfex-config.js.map