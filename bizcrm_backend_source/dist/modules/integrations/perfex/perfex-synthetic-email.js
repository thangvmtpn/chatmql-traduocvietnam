 ...
 */
export function synthesizeEmail(input, fallbackDomain) {
 ...
 */
export function isSyntheticEmail(email, fallbackDomain) {
    if (!email)
        return false;
...
//# sourceMappingURL=perfex-synthetic-email.js.map