...
export function brandingKeyForImage(kind) {
 ...
 * oversized payload.
 */
export function decodeBrandingImage(dataUrl) {
    ...
    if (!ALLOWED_IMAGE_MIMES.has(mime)) {
        throw new BrandingImageError(`Định dạng ảnh "${mime}" không được hỗ trợ. Dùng PNG, JPEG, WebP, GIF, SVG hoặc ICO.`);
    }
    let buffer;
    try {
...
//# sourceMappingURL=branding-image.js.map