...
export interface ChangeStageResult {
  log: { id: string; fromStage: string | null; toStage: string; createdAt: Date }
 ...
 * auth + org scoping.
 */
export async function changeLifecycleStage(input: ChangeStageInput): Promise<ChangeStageResult> {
