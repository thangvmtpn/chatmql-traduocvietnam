...
const PRICE_PER_MILLION: Record<string, Price> = {
 ...
 */
function resolvePrice(model: string): Price | undefined {
...
export function estimateCost(model: string, raw: GenerateRaw): number {
