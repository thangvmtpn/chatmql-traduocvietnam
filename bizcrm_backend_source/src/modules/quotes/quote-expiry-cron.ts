...
export async function runQuoteDailyJobs(): Promise<{ expiring: number; unviewed: number; expired: number }> {
...
export function initQuoteExpiryCron(): void {
  if (task) return // idempotent — gọi 2 lần không tạo job trùng
