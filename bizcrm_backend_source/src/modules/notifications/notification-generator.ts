 ...
 */
export function initNotificationGenerator(): void {
  // Run every 5 minutes
 ...
 */
async function generateUnrepliedAlerts(): Promise<void> {
 ...
 */
async function generateConnectivityAlerts(): Promise<void> {
